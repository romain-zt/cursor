...
5. `zedos/.cursor/rules/01-architecture-layers.md` for the canonical infrastructure-layer rules.
6. The current `prisma/schema.prisma` (pre-migration) or `packages/database/src/schema/` (post-migration).
