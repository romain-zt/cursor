...
8. `zedos/.cursor/rules/` — the in-repo canonical architecture rules.
9. The codebase areas the Plan will touch (read-only) — to determine real paths under the layout-in-effect (`71-monorepo-context.mdc`).
