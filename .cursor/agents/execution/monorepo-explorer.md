...
description: Read-only navigator. Answers "where does X live?", "what calls Y?", "what tests cover Z?" by scanning the codebase under the layout in effect. Never writes files. Mirrors Kolecto's monorepo-explorer pattern, adapted for Next.js.
---
