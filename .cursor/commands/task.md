...
| `scaffold <spec-path>` | After an approved proposal, create Task files from `.cursor/templates/product/task.template.md` |
...
Templates: `.cursor/templates/product/task.template.md`
Checker: `.cursor/checkers/scope-readiness-checker.md` (Part 6 + CC)
Operational skill: `.cursor/skills/task/task-builder/SKILL.md`
...
Runs TK-01..TK-N + CC-01..CC-05 from `.cursor/checkers/scope-readiness-checker.md` Part 6.
